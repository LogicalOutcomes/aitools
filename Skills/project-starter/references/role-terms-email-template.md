...
## Role & Terms Template for Contractors

**Subject:** Your Roles and Terms for [PROJECT CODE]
...
Please refer to the overall project work plan and team contact information at any time. Should there be a change to the Project Charter, you will be notified. We will not make any change to the scope or budget of your work without discussing with you first.
...
### Roles & Terms for [Project name]

*Cut and Paste ONE of the below*
...
If you anticipate you will need to work more than the maximum number of hours in the project or within a week, please notify the Project Manager with enough advance notice so that alternatives can be considered, e.g., reducing the scope or redistributing tasks.

#### Terms: Fixed price

You will be paid a fixed price for your role and assigned tasks on the project, regardless of the number of hours you incur.

If the scope changes during the course of the project, we may renegotiate the price based on the increased or decreased effort that is required. Unless a change is confirmed in writing (email is fine), you are responsible for managing the scope within the fixed price.

In general, there is a maximum cap of 40 hours per 7-day period unless approved by the Project Manager. This policy is to reduce the risk of going over budget unexpectedly during a weekly period. It also is intended to discourage the practice of working more than 8 hours per day.

If you anticipate you will need to work more than the maximum number of hours in the project or within a week, please notify the Project Manager with enough advance notice so that alternatives can be considered, e.g., reducing the scope or redistributing tasks.

#### Terms: Hourly as directed by PM
...
**Invoice & Payment Schedule:** - choose "Hourly with maximum term" OR "Fixed price term" below
...
## Role & Terms Template for Employees
...
Please review your role and terms for this project below. If you have any concerns about the terms, reply to this e-mail within **three** business days; otherwise, we will assume that you are in agreement.
