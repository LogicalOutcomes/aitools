#!/usr/bin/env python3
"""
Exported Literature Results Processor

Parses, deduplicates, filters, and formats literature search results that
have been exported from a database (e.g., PsycINFO, PubMed, Google Scholar).

This script does NOT search databases directly — it processes results you
have already exported and saved as a JSON file.

Usage:
    python parse_exported_results.py <results.json> [options]
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python parse_exported_results.py <results.json> [options]")
        print("\nOptions:")
